...
@section('content')
    <div class="container"><br>
        <div id="puzzle-container">
            <div id="full-image" style="background-image: url('{{ asset('assets/img/puzzle.jpg') }}');"></div>
            <div id="puzzle-board"></div>
            <div id="pieces" class="pieces"></div>
        </div>
        <button class="btn btn-primary" id="start-game">Start Game</button>
        <button class="btn btn-primary" id="check-completion" style="display: none;">Check Completion</button>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const imageSrc = '{{ asset('assets/img/elephant.jpg') }}';
            ...
            startGameButton.addEventListener('click', () => {
                ...
                enableDragAndDrop();
                checkCompletionButton.style.display = 'block';
            });
